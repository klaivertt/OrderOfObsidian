...
import net.mcreator.orderofobsidian.procedures.RiceStage3UpdateTickProcedure;
...
public class RiceStage3Block extends Block {
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, Random random) {
		...
		RiceStage3UpdateTickProcedure.execute(world, x, y, z);
	}

	@OnlyIn(Dist.CLIENT)
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(OrderofobsidianModBlocks.RICE_STAGE_3, renderType -> renderType == RenderType.cutoutMipped());
	}
