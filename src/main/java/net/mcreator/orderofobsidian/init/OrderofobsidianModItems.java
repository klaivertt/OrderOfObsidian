...
public class OrderofobsidianModItems {
	...
	public static final Item ANGMAR_HELMET = register(new AngmarItem.Helmet());
	public static final Item ANGMAR_CHESTPLATE = register(new AngmarItem.Chestplate());
	public static final Item ANGMAR_LEGGINGS = register(new AngmarItem.Leggings());
	public static final Item ANGMAR_BOOTS = register(new AngmarItem.Boots());
