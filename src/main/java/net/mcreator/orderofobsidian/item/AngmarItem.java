...
public abstract class AngmarItem extends ArmorItem {
	public AngmarItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends AngmarItem {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(OrderofobsidianModTabs.TAB_ARMOR));
			setRegistryName("angmar_chestplate");
		}
