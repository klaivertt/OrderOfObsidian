...
public class MedievalTentFeature extends Feature<NoneFeatureConfiguration> {
	public static final MedievalTentFeature FEATURE = (MedievalTentFeature) new MedievalTentFeature()
			.setRegistryName("orderofobsidian:medieval_tent");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public MedievalTentFeature() {
