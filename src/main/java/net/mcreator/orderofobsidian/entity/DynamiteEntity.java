...
import net.mcreator.orderofobsidian.procedures.DynamiteProjectileHitsBlockProcedure;
...
public class DynamiteEntity extends AbstractArrow implements ItemSupplier {
	public DynamiteEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(OrderofobsidianModEntities.DYNAMITE, world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(OrderofobsidianModItems.DYNAMITE);
	}
	...
	public void tick() {
		...
		if (this.inGround) {
			...
			DynamiteProjectileHitsBlockProcedure.execute(world, x, y, z);
			this.discard();
		}
	}

	public static DynamiteEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		DynamiteEntity entityarrow = new DynamiteEntity(OrderofobsidianModEntities.DYNAMITE, entity, world);
	...
	public static DynamiteEntity shoot(LivingEntity entity, LivingEntity target) {
		DynamiteEntity entityarrow = new DynamiteEntity(OrderofobsidianModEntities.DYNAMITE, entity, entity.level);
