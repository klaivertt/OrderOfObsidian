...
public class AngmaHammerItem extends PickaxeItem {
	public AngmaHammerItem() {
		super(new Tier() {
			public int getUses() {
				return 700;
			}
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(OrderofobsidianModItems.URUK_INGOT), new ItemStack(OrderofobsidianModItems.MITRIL_INGOT));
			}
		}, 1, -3f, new Item.Properties().tab(OrderofobsidianModTabs.TAB_TOOLS));
		setRegistryName("angma_hammer");
	}
