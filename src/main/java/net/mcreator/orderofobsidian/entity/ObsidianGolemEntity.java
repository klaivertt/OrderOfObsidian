...
public class ObsidianGolemEntity extends IronGolem {
	public ObsidianGolemEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(OrderofobsidianModEntities.OBSIDIAN_GOLEM, world);
	}

	public ObsidianGolemEntity(EntityType<ObsidianGolemEntity> type, Level world) {
		super(type, world);
		xpReward = 15;
		setNoAi(false);
	}
