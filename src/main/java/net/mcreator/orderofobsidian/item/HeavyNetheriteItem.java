...
public abstract class HeavyNetheriteItem extends ArmorItem {
	...
	public static class Helmet extends HeavyNetheriteItem {
		public Helmet() {
			...
			setRegistryName("heavy_netherite_helmet");
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "orderofobsidian:textures/models/armor/heavy_netherite__layer_1.png";
		}
	}
	...
	public static class Chestplate extends HeavyNetheriteItem {
		public Chestplate() {
			...
			setRegistryName("heavy_netherite_chestplate");
		}
	...
	public static class Leggings extends HeavyNetheriteItem {
		public Leggings() {
			...
			setRegistryName("heavy_netherite_leggings");
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "orderofobsidian:textures/models/armor/heavy_netherite__layer_2.png";
		}
	}
	...
	public static class Boots extends HeavyNetheriteItem {
		public Boots() {
			...
			setRegistryName("heavy_netherite_boots");
		}
