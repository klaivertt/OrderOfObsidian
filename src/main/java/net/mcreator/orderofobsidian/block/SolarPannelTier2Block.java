...
public class SolarPannelTier2Block extends Block {
	public SolarPannelTier2Block() {
		super(Block.Properties.of(Material.STONE).sound(SoundType.GLASS).strength(1f, 10f).lightLevel(s -> 0).noOcclusion()
				.isRedstoneConductor((bs, br, bp) -> false));
		setRegistryName("solar_pannel_tier_2");
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(OrderofobsidianModBlocks.SOLAR_PANNEL_TIER_2, renderType -> renderType == RenderType.cutout());
	}
}
