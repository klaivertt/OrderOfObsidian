...
public class ObsidianGolemheadUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (((world.getBlockState(new BlockPos((int) (x + 1), (int) (y - 1), (int) z))).getBlock() == Blocks.OBSIDIAN
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new ObsidianGolemEntity(OrderofobsidianModEntities.OBSIDIAN_GOLEM, _level);
