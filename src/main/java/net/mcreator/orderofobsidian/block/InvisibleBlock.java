...
import net.mcreator.orderofobsidian.procedures.InvisibleUpdateTickProcedure;
...
public class InvisibleBlock extends Block {
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		...
		return box(3.2, -1.6, 3.2, 9.6, 1.6, 9.6).move(offset.x, offset.y, offset.z);
	}
	...
	public void onPlace(BlockState blockstate, Level world, BlockPos pos, BlockState oldState, boolean moving) {
		...
		world.getBlockTicks().scheduleTick(pos, this, 18);
	}
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, Random random) {
		...
		InvisibleUpdateTickProcedure.execute(world, x, y, z);
		world.getBlockTicks().scheduleTick(pos, this, 18);
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(OrderofobsidianModBlocks.INVISIBLE, renderType -> renderType == RenderType.translucent());
	}
