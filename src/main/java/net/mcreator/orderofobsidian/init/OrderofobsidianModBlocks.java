...
import net.mcreator.orderofobsidian.block.EdrueliumOreBlock;
import net.mcreator.orderofobsidian.block.EdrueliumBlockBlock;
...
public class OrderofobsidianModBlocks {
	...
	public static final Block EDRUELIUM_ORE = register(new EdrueliumOreBlock());
	public static final Block EDRUELIUM_BLOCK = register(new EdrueliumBlockBlock());
