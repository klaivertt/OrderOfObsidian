...
public class SpeedEnchantemementProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		if (entity == null)
			return;
		if (EnchantmentHelper.getItemEnchantmentLevel(OrderofobsidianModEnchantments.SPEED,
			...
			if (entity instanceof LivingEntity _entity)
				_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 60,
						(int) (EnchantmentHelper.getItemEnchantmentLevel(OrderofobsidianModEnchantments.SPEED,
