package net.mcreator.orderofobsidian.client.model;
...
public class Modelhorse<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("orderofobsidian", "modelhorse"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 34).mirror()
				.addBox(-5.0F, -8.0F, -19.0F, 10.0F, 10.0F, 24.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 11.0F, 9.0F));
		PartDefinition TailA = partdefinition
				.addOrReplaceChild(
						"TailA", CubeListBuilder.create().texOffs(44, 0).mirror()
		...
		PartDefinition TailB = partdefinition
				.addOrReplaceChild(
						"TailB", CubeListBuilder.create().texOffs(38, 7).mirror()
								.addBox(-1.5F, -2.0F, 3.0F, 3.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 3.0F, 14.0F, -1.1345F, 0.0F, 0.0F));
		PartDefinition TailC = partdefinition
				.addOrReplaceChild(
						"TailC", CubeListBuilder.create().texOffs(24, 3).mirror()
		...
		PartDefinition Leg1A = partdefinition.addOrReplaceChild("Leg1A", CubeListBuilder.create().texOffs(78, 29).mirror()
				.addBox(-1.5F, -2.0F, -2.5F, 4.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, 9.0F, 11.0F));
		PartDefinition Leg1B = partdefinition.addOrReplaceChild("Leg1B", CubeListBuilder.create().texOffs(78, 43).mirror()
				.addBox(-1.0F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, 16.0F, 11.0F));
		PartDefinition Leg1C = partdefinition.addOrReplaceChild("Leg1C", CubeListBuilder.create().texOffs(78, 51).mirror()
				.addBox(-1.5F, 5.1F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, 16.0F, 11.0F));
		PartDefinition Leg2A = partdefinition.addOrReplaceChild("Leg2A", CubeListBuilder.create().texOffs(96, 29).mirror()
				.addBox(-2.5F, -2.0F, -2.5F, 4.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(4.0F, 9.0F, 11.0F));
		PartDefinition Leg2B = partdefinition.addOrReplaceChild("Leg2B", CubeListBuilder.create().texOffs(96, 43).mirror()
				.addBox(-2.0F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(4.0F, 16.0F, 11.0F));
		PartDefinition Leg2C = partdefinition.addOrReplaceChild("Leg2C", CubeListBuilder.create().texOffs(96, 51).mirror()
				.addBox(-2.5F, 5.1F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(4.0F, 16.0F, 11.0F));
		PartDefinition Leg3A = partdefinition.addOrReplaceChild("Leg3A", CubeListBuilder.create().texOffs(44, 29).mirror()
				.addBox(-1.1F, -1.0F, -2.1F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, 9.0F, -8.0F));
		PartDefinition Leg3B = partdefinition.addOrReplaceChild("Leg3B", CubeListBuilder.create().texOffs(44, 41).mirror()
				.addBox(-1.1F, 0.0F, -1.6F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, 16.0F, -8.0F));
		PartDefinition Leg3C = partdefinition.addOrReplaceChild("Leg3C", CubeListBuilder.create().texOffs(44, 51).mirror()
				.addBox(-1.6F, 5.1F, -2.1F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, 16.0F, -8.0F));
		PartDefinition Leg4A = partdefinition.addOrReplaceChild("Leg4A", CubeListBuilder.create().texOffs(60, 29).mirror()
				.addBox(-1.9F, -1.0F, -2.1F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(4.0F, 9.0F, -8.0F));
		PartDefinition Leg4B = partdefinition.addOrReplaceChild("Leg4B", CubeListBuilder.create().texOffs(60, 41).mirror()
				.addBox(-1.9F, 0.0F, -1.6F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(4.0F, 16.0F, -8.0F));
		PartDefinition Leg4C = partdefinition.addOrReplaceChild("Leg4C", CubeListBuilder.create().texOffs(60, 51).mirror()
				.addBox(-2.4F, 5.1F, -2.1F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(4.0F, 16.0F, -8.0F));
		PartDefinition Head = partdefinition
				.addOrReplaceChild(
						"Head", CubeListBuilder.create().texOffs(0, 0).mirror()
		...
		PartDefinition UMouth = partdefinition
				.addOrReplaceChild(
						"UMouth", CubeListBuilder.create().texOffs(24, 18).mirror()
		...
		PartDefinition MuleEarR = partdefinition
				.addOrReplaceChild(
						"MuleEarR", CubeListBuilder.create().texOffs(0, 12).mirror()
								.addBox(-2.0F, -16.0F, 4.0F, 2.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 4.0F, -10.0F, 0.5236F, 0.0F, -0.2618F));
		PartDefinition Neck = partdefinition
				.addOrReplaceChild(
						"Neck", CubeListBuilder.create().texOffs(0, 12).mirror()
								.addBox(-1.95F, -9.8F, -2.0F, 4.0F, 14.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 4.0F, -10.0F, 0.5236F, 0.0F, 0.0F));
		PartDefinition Bag1 = partdefinition
				.addOrReplaceChild(
						"Bag1", CubeListBuilder.create().texOffs(0, 34).mirror()
		...
		PartDefinition Bag2 = partdefinition.addOrReplaceChild("Bag2",
				CubeListBuilder.create().texOffs(0, 47).mirror().addBox(-5.0F, 0.0F, 0.0F, 8.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-4.5F, 3.0F, 10.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition Saddle = partdefinition.addOrReplaceChild("Saddle", CubeListBuilder.create().texOffs(80, 0).mirror()
				.addBox(-5.0F, 0.0F, -3.0F, 10.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 2.0F, 2.0F));
		PartDefinition SaddleB = partdefinition.addOrReplaceChild("SaddleB", CubeListBuilder.create().texOffs(106, 9).mirror()
				.addBox(-1.5F, -1.0F, -3.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 2.0F, 2.0F));
		PartDefinition SaddleC = partdefinition.addOrReplaceChild("SaddleC", CubeListBuilder.create().texOffs(80, 9).mirror()
				.addBox(-4.0F, -1.0F, 3.0F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 2.0F, 2.0F));
		PartDefinition SaddleL2 = partdefinition.addOrReplaceChild("SaddleL2", CubeListBuilder.create().texOffs(74, 0).mirror()
				.addBox(-0.5F, 6.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-5.0F, 3.0F, 2.0F));
		PartDefinition SaddleL = partdefinition.addOrReplaceChild("SaddleL", CubeListBuilder.create().texOffs(70, 0).mirror()
				.addBox(-0.5F, 0.0F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-5.0F, 3.0F, 2.0F));
		PartDefinition SaddleR2 = partdefinition.addOrReplaceChild("SaddleR2", CubeListBuilder.create().texOffs(74, 4).mirror()
				.addBox(-0.5F, 6.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(5.0F, 3.0F, 2.0F));
		PartDefinition SaddleR = partdefinition.addOrReplaceChild("SaddleR", CubeListBuilder.create().texOffs(80, 0).mirror()
				.addBox(-0.5F, 0.0F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(5.0F, 3.0F, 2.0F));
		PartDefinition SaddleMouthL = partdefinition.addOrReplaceChild(
				"SaddleMouthL", CubeListBuilder.create().texOffs(74, 13).mirror()
						.addBox(-2.5F, -8.0F, -4.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 4.0F, -10.0F, 0.5236F, 0.0F, 0.0F));
		PartDefinition SaddleMouthR = partdefinition.addOrReplaceChild(
				"SaddleMouthR", CubeListBuilder.create().texOffs(74, 13).mirror()
						.addBox(1.5F, -8.0F, -4.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 4.0F, -10.0F, 0.5236F, 0.0F, 0.0F));
		PartDefinition SaddleMouthLine = partdefinition.addOrReplaceChild(
				"SaddleMouthLine", CubeListBuilder.create().texOffs(44, 10).mirror()
						.addBox(-2.6F, -6.0F, -6.0F, 0.0F, 3.0F, 16.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 4.0F, -10.0F));
		PartDefinition SaddleMouthLineR = partdefinition.addOrReplaceChild("SaddleMouthLineR", CubeListBuilder.create().texOffs(44, 5).mirror()
				.addBox(2.6F, -6.0F, -6.0F, 0.0F, 3.0F, 16.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 4.0F, -10.0F));
		PartDefinition Mane = partdefinition
				.addOrReplaceChild(
						"Mane", CubeListBuilder.create().texOffs(58, 0).mirror()
								.addBox(-1.0F, -11.5F, 5.0F, 2.0F, 16.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 4.0F, -10.0F, 0.5236F, 0.0F, 0.0F));
		PartDefinition HeadSaddle = partdefinition.addOrReplaceChild(
				"HeadSaddle", CubeListBuilder.create().texOffs(80, 12).mirror()
