...
import net.mcreator.orderofobsidian.item.WoodElvenItem;
...
import net.mcreator.orderofobsidian.item.RawEdrueliumItem;
...
import net.mcreator.orderofobsidian.item.ParticleironItem;
import net.mcreator.orderofobsidian.item.ParticleMithrilItem;
import net.mcreator.orderofobsidian.item.ParticleGoldItem;
import net.mcreator.orderofobsidian.item.ParticleBauheriteItem;
import net.mcreator.orderofobsidian.item.ParticleAvenroniteItem;
import net.mcreator.orderofobsidian.item.ParticleAikigiteItem;
...
import net.mcreator.orderofobsidian.item.IthilienArmorItem;
...
import net.mcreator.orderofobsidian.item.GalvornItem;
import net.mcreator.orderofobsidian.item.GalvornIngotItem;
...
import net.mcreator.orderofobsidian.item.EdrueliumarmorItem;
import net.mcreator.orderofobsidian.item.EdrueliumIngotItem;
import net.mcreator.orderofobsidian.item.EdhelvirItem;
...
public class OrderofobsidianModItems {
	...
	public static final Item FORGE = register(OrderofobsidianModBlocks.FORGE, OrderofobsidianModTabs.TAB_BLOC_K);
	...
	public static final Item GALVORN_HELMET = register(new GalvornItem.Helmet());
	public static final Item GALVORN_CHESTPLATE = register(new GalvornItem.Chestplate());
	public static final Item GALVORN_LEGGINGS = register(new GalvornItem.Leggings());
	public static final Item GALVORN_BOOTS = register(new GalvornItem.Boots());
	public static final Item MATERIALBREAKER = register(OrderofobsidianModBlocks.MATERIALBREAKER, OrderofobsidianModTabs.TAB_BLOC_K);
	public static final Item PARTICLEIRON = register(new ParticleironItem());
	public static final Item PARTICLE_GOLD = register(new ParticleGoldItem());
	public static final Item PARTICLE_AIKIGITE = register(new ParticleAikigiteItem());
	public static final Item PARTICLE_BAUHERITE = register(new ParticleBauheriteItem());
	public static final Item PARTICLE_AVENRONITE = register(new ParticleAvenroniteItem());
	public static final Item PARTICLE_MITHRIL = register(new ParticleMithrilItem());
	public static final Item EDHELVIR = register(new EdhelvirItem());
	public static final Item GALVORN_INGOT = register(new GalvornIngotItem());
	public static final Item ITHILIEN_ARMOR_HELMET = register(new IthilienArmorItem.Helmet());
	public static final Item ITHILIEN_ARMOR_CHESTPLATE = register(new IthilienArmorItem.Chestplate());
	public static final Item ITHILIEN_ARMOR_LEGGINGS = register(new IthilienArmorItem.Leggings());
	public static final Item ITHILIEN_ARMOR_BOOTS = register(new IthilienArmorItem.Boots());
	public static final Item WOOD_ELVEN_HELMET = register(new WoodElvenItem.Helmet());
	public static final Item WOOD_ELVEN_CHESTPLATE = register(new WoodElvenItem.Chestplate());
	public static final Item WOOD_ELVEN_LEGGINGS = register(new WoodElvenItem.Leggings());
	public static final Item WOOD_ELVEN_BOOTS = register(new WoodElvenItem.Boots());
	public static final Item EDRUELIUM_INGOT = register(new EdrueliumIngotItem());
	public static final Item EDRUELIUM_ORE = register(OrderofobsidianModBlocks.EDRUELIUM_ORE, OrderofobsidianModTabs.TAB_BLOC_K);
	public static final Item EDRUELIUM_BLOCK = register(OrderofobsidianModBlocks.EDRUELIUM_BLOCK, OrderofobsidianModTabs.TAB_SPIRIT);
	public static final Item RAW_EDRUELIUM = register(new RawEdrueliumItem());
	public static final Item EDRUELIUMARMOR_HELMET = register(new EdrueliumarmorItem.Helmet());
	public static final Item EDRUELIUMARMOR_CHESTPLATE = register(new EdrueliumarmorItem.Chestplate());
	public static final Item EDRUELIUMARMOR_LEGGINGS = register(new EdrueliumarmorItem.Leggings());
	public static final Item EDRUELIUMARMOR_BOOTS = register(new EdrueliumarmorItem.Boots());
