...
public class SolarPannelTierVBlock extends Block {
	public SolarPannelTierVBlock() {
		super(Block.Properties.of(Material.STONE).sound(SoundType.GLASS).strength(1f, 10f).lightLevel(s -> 0).noOcclusion()
				.isRedstoneConductor((bs, br, bp) -> false));
		setRegistryName("solar_pannel_tier_v");
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(OrderofobsidianModBlocks.SOLAR_PANNEL_TIER_V, renderType -> renderType == RenderType.cutout());
	}
}
